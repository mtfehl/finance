...
# Create an graph input where the user types in a ticker, and can see an associated graph to the ticker
    # Add the option to adjust for time window (zoom in/out)
# Make tables for inputted ticker by user
    # STD, Return, Sharpe, Skew, Kurtosis
# Ability to cross reference two (maybe multiple) tickers
# Price to earnings ratio of each ticker (find in textbook)